<script>
  ...
  import SiYoutube from 'virtual:icons/simple-icons/youtube'
  ...
  const iconBtn = 'grid size-10 shrink-0 place-items-center text-gray-500 no-underline transition-colors hover:text-gray-800'
