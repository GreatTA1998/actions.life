...
<div {onclick}
  class={[
    'cursor-pointer relative flex flex-col gap-y-2 py-4 px-8 w-[290px] rounded-[20px] border border-[#e5e5e5]',
...
>
  <div class="flex items-center gap-x-2 font-medium">
    ...
    <div class="text-gray-600 text-lg">Sign in with Google</div>

    <MslArrowOutward class="pointer-events-none size-5 text-neutral-500" />
  </div>
