<script>
  ...
  let audience = $state('photo-user')
</script>

<div class="flex flex-col items-center gap-12 w-full">
  <div class="flex flex-wrap justify-center gap-6 w-full max-w-[900px] px-6">
    <div onclick={() => audience = 'photo-user'}
      class={[
        'flex items-center justify-center gap-6 p-8 min-w-[240px] flex-1 rounded-[20px] border border-[#e5e5e5]',
        'shadow-[0_4px_24px_rgba(0,0,0,0.06)]', 
        audience === 'photo-user' && 'shadow-[0_8px_32px_rgba(0,0,0,0.3)]'
      ]}
    >
    ...
    <div onclick={() => audience = 'notion-user'}
      class={[
        'flex items-center justify-center gap-6 p-8 min-w-[240px] flex-1 rounded-[20px] border border-[#e5e5e5]',
        'shadow-[0_4px_24px_rgba(0,0,0,0.06)]', 
        audience === 'notion-user' && 'shadow-[0_8px_32px_rgba(0,0,0,0.2)]'
      ]}
    >
      <GoogleCalendarLogo/>
